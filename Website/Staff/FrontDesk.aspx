                                ...
                                <asp:Panel ID="WalkInSeatingPanel" runat="server"
                                    ...
                                    <span class="input-group-addon">
                                        <asp:DropDownList ID="WaiterList" runat="server"
                                            ...
                                            AppendDataBoundItems="true" DataSourceID="WaiterDS" DataTextField="FullName" DataValueField="WaiterID">
                                            <asp:ListItem Value="0">[select a waiter]</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:ObjectDataSource runat="server" ID="WaiterDS" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllWaiters" TypeName="eRestaurant.BLL.RestaurantAdminController"></asp:ObjectDataSource>
                                    </span>
                                    <span class="input-group-addon"
