...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ListView ID="ListView1" runat="server" DataSourceID="SpecialEventDataSource" InsertItemPosition="LastItem" DataKeyNames="EventCode">
        ...
        <InsertItemTemplate>
            <div style="">
                <asp:LinkButton runat="server" CommandName="Insert" Text="Insert" ID="InsertButton"> Insert <span class="glyphicon glypchicon-plus"></span></asp:LinkButton>
                &nbsp &nbsp;
                <asp:LinkButton runat="server" CommandName="Cancel" Text="Clear" ID="CancelButton"> Clear <span class="glyphicon glypchicon-plus"> </span></asp:LinkButton>
                &nbsp &nbsp &nbsp;
                <asp:CheckBox Checked='<%# Bind("Active") %>' runat="server" ID="ActiveCheckBox" Text="Active" />
                &mdash;
                ...
                <asp:Label ID="Label2" runat="server" AssociatedControlID="DescriptionTextBox" CssClass="control-label">Description</asp:Label>
                <asp:TextBox Text='<%# Bind("Description") %>' runat="server" ID="DescriptionTextBox" />
            </div>
        </InsertItemTemplate>
        <ItemTemplate>
